...
CREATE OR REPLACE PACKAGE PKG_KPI_INVENTARIO IS
    PROCEDURE PROC_KPI4_STOCK_CATEGORIA;
    PROCEDURE RUN_ALL;
END PKG_KPI_INVENTARIO;
/

--creación del cuerpo del package
CREATE OR REPLACE PACKAGE BODY PKG_KPI_INVENTARIO IS
...
-- Tipos RECORD
TYPE T_KPI4_REC IS RECORD (
    FRANQUICIA              KPI_4.FRANQUICIA%TYPE,
    STOCK_ACTUAL            KPI_4.STOCK_AGREGADO_ACTUAL%TYPE,
    PRODUCTOS_BAJO_STOCK    KPI_4.PRODUCTOS_BAJO_STOCK%TYPE,
    TOTAL_PRODUCTOS         KPI_4.TOTAL_PRODUCTOS%TYPE,
    STOCK_ANTERIOR_REF      KPI_4.STOCK_AGREGADO_ACTUAL%TYPE,
    VARIACION_PORCENTAJE    KPI_4.VARIACION_PORCENTAJE%TYPE,
    ESTADO_STOCK            KPI_4.ESTADO_STOCK%TYPE,
    FECHA_ACTUALIZACION     KPI_4.FECHA_ACTUALIZACION%TYPE
);

TYPE T_KPI4_ARRAY IS TABLE OF T_KPI4_REC;


-- =================================================================
-- PROCEDURE 4
-- =================================================================
PROCEDURE PROC_KPI4_STOCK_CATEGORIA IS
--==================Definicion de variables==================--

--variable para control de errores
C_PROC_NAME CONSTANT VARCHAR2(30) := 'PROC_KPI4_STOCK_CATEGORIA';

-- Colección para resultados
RESULTADOS_KPI4 T_KPI4_ARRAY;
...
BEGIN
DBMS_OUTPUT.PUT_LINE('--- Iniciando PKG_KPI_INVENTARIO ---');
PROC_KPI4_STOCK_CATEGORIA;
DBMS_OUTPUT.PUT_LINE('--- PKG_KPI_INVENTARIO Finalizado ---');
END RUN_ALL;
